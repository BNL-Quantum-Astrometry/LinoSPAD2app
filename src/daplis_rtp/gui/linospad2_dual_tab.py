...
two stacked browse rows (one per board) and the plot.  The right frame
...
class LinoSPAD2Dual(QtWidgets.QWidget):
    def __init__(self, parent=None):
        ...
        self.horizontalSlider_leftXLim = QtWidgets.QSlider(
            QtCore.Qt.Horizontal, self.frame
        )
        ...
        self.horizontalSlider_rightXLim = QtWidgets.QSlider(
            QtCore.Qt.Horizontal, self.frame
        )
        self.horizontalSlider_rightXLim.setMinimumSize(QtCore.QSize(0, 28))
        self.gridLayout.addWidget(
            self.horizontalSlider_rightXLim, 8, 1, 1, 2
        )
        ...
        self.horizontalSlider_leftXLim.setMaximum(511)
        self.horizontalSlider_rightXLim.setMinimum(0)
        self.horizontalSlider_rightXLim.setMaximum(511)
        self.horizontalSlider_rightXLim.setSliderPosition(511)
